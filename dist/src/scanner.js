...
export async function scanRepository(target, options) {
    ...
    return scoreResults(root, context.profile, options.mode, [...staticResults, ...dynamic.results], dynamic.commands);
}
