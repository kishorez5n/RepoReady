...
const fixture = (name) => path.resolve(process.cwd(), "test", "fixtures", name);
...
test("invalid repository configuration fails explicitly", async () => {
    await assert.rejects(scanRepository(fixture("invalid-config"), { mode: "scan" }), /Invalid JSON in Repo Ready configuration/);
});
//# sourceMappingURL=repo-ready.test.js.map